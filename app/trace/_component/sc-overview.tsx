            ...
            {status && status.map((item: any) => (
                <div className="pb-4 grid w-full grid-cols-1 sm:grid-cols-5">
                    ...
                    <div className="border-primary-500 border-l-2 px-6 py-2 sm:col-span-3">
                        ...
                        <p className="text-sm font-medium text-gray-600">
                            at <span className="text-gray-800 text-base ">country</span></p>
                        <p className="text-sm font-medium text-gray-600">
                            Company address: <span className="text-gray-800 text-base">address</span></p>
                    </div>
                </div>
            ))}
